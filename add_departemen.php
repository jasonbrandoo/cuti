...
$halaman = "departemen"; // halaman
$dataapa = "Departemen"; // data
$tabeldatabase = "departemen"; // tabel database
          ...
          <form class="form-horizontal" method="post" action="add_<?php echo $halaman; ?>" id="Myform">
			  ...
			  <div class="row">
                <div class="form-group col-md-6 col-xs-12" >
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control" id="kode" name="kode" value="<?php echo $kode; ?>"  placeholder="Masukan Kode Departemen" maxlength="50" required>
                  </div>
                </div>
				</div>
				...
				<div class="row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" class="form-control" id="nama" name="nama" value="<?php echo $nama; ?>" placeholder="Masukan Nama Departemen" maxlength="50">
                  </div>
                </div>
				</div>
