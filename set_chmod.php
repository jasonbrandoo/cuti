...
?>
                ...
                <div class="form-group">
				 ...
				 <div class="form-group">
                  <label for="menu2" class="col-sm-3 control-label">Menu Departemen</label>
                  <div class="col-sm-9">
				 ...
				 <div class="form-group">
                  <label for="menu3" class="col-sm-3 control-label">Menu Lokasi</label>
                  <div class="col-sm-9">
				 ...
				 <div class="form-group">
                  <label for="menu4" class="col-sm-3 control-label">Menu Jabatan</label>
                  <div class="col-sm-9">
				 ...
				 <div class="form-group">
                  <label for="menu5" class="col-sm-3 control-label">Menu Pegawai</label>
                  <div class="col-sm-9">
                ...
                <div class="form-group">
                         <label for="menu6" class="col-sm-3 control-label">Menu Pengajuan Cuti</label>
                         <div class="col-sm-9">
                       ...
                       <div class="form-group">
                                 <label for="menu7" class="col-sm-3 control-label">Menu Approvement</label>
                                 <div class="col-sm-9">
