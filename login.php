...
?>
<html>
<title>Cuti Online Pegawai</title>
<?php head();
...
if($_SERVER["REQUEST_METHOD"]=="POST"){
  ...
  if(mysqli_num_rows($hasil)>0){
    ...
    $sql="select *, jabatan.nama as jabatan, pegawai.no as no, pegawai.nama as nama from pegawai inner join jabatan on jabatan.kode = pegawai.jabatan where nik='$username' and password='$password'";
    $hasil= mysqli_query($conn,$sql);
    if(mysqli_num_rows($hasil)>0){
      $data=mysqli_fetch_assoc($hasil);
      $_SESSION['username']=$data['nik'];
      $_SESSION['nama']=$data['nama'];
      $_SESSION['jabatan']=$data['jabatan'];
      $_SESSION['avatar']=$data['foto'];
      $_SESSION['nouser']=$data['no'];
      $_SESSION['mod']='2';
      $_SESSION['baseurl']=$baseurl;
      login_validate();
  ...
  <div id="loginbox" style="margin-top:50px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
    ...
    <div class="login-box">
      <div class="login-logo">
        <a href="">Cuti<b> ONLINE </b>Pegawai</a>
        <img src="./assets/Logo.png">
        <div id="<?php echo($gagal) ?>">
        </div>
      </div>
      <!-- /.login-logo -->
