	<header class="main-header">
        <title>Cuti Online Pegawai</title>
                ...
                <a href="<?php  echo $_SESSION['baseurl'];?>" class="logo">
                    ...
                    <span class="logo-mini">c<b>OP</b></span>
                    <!-- logo for regular state and mobile devices -->
                 <span class="logo-lg">Cuti <b>ONLINE</b> Pegawai</span>
                </a>
                  ...
                  <?php  echo $_SESSION['nama']; ?> - <?php  echo $_SESSION['jabatan']; ?></p>
                                    ...
                                    <li class="user-footer">
                                        <div class="pull-left">
                                              ...
                                              <a href="add_<?php echo $_SESSION['jabatan'];?>?no=<?php  echo $_SESSION['nouser']; ?>" class="btn btn-default btn-flat">Profil</a>
																							<?php }?>
                                        </div>
